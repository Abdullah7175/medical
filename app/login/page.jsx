...
//         <h1 className="text-2xl font-semibold">Nutricare</h1>
//       </div>
...
//               )}
//             </div>
//             <Button type="submit" className="w-full bg-blue-900 hover:bg-blue-950 text-amber-50">
//               Login
//             </Button>
//           </form>
//         </CardContent>
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      if (demoUsers[email] === password) {
        // Save intended dashboard role in localStorage
        ...
        router.push("/twofactor"); // Redirect to 2FA page
      } else {
